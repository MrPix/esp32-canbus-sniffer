...
can send --ext 0x0CFFA594 10 01
```

The transmit command accepts a standard 11-bit hexadecimal ID and zero to eight
hexadecimal data bytes. Add `--ext` before the ID to send a 29-bit extended
identifier instead. Run `can setbitrate` again to change the transmit
